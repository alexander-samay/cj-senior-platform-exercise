# Senior Platform Engineer — Take-Home Assignment
...
- **What else in this configuration can stop a `severity: critical` alert in this cluster from
  paging**, independent of the routing above? Say under what circumstances it bites.
